...
<body class="signup-page" style="background-image: url(assets/img/back.jpg); background-size: cover">
	...
	<nav class="navbar navbar-transparent navbar-absolute">
    	<div class="container">
        	...
        	<div class="navbar-header">
        		...
        		<a class="navbar-brand" href="http://www.creative-tim.com">TransCorp Inc.</a>
        	</div>
			...
			<footer class="footer">
		        <div class="container">
		            ...
		            <div class="copyright pull-right">
		                &copy; 2017, made with <i class="fa fa-heart heart"></i> by <a href="#" target="_blank">VV & Angad</a>
		            </div>
		        </div>
		    </footer>
